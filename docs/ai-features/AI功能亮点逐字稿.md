...
> 用于向评委介绍项目时的逐字稿，第一人称形式，包含实现思路和关键代码

---

## 开场介绍

大家好，我是这个 AI 智能博客系统的开发者。今天我想向大家介绍我在这个项目中实现的 7 个核心 AI 功能亮点。这个系统基于 Next.js 15 构建，集成了 RAG 检索增强生成、智能语义分块、向量索引等能力，为内容创作提供全方位的 AI 辅助。
...
以上就是我在这个 AI 博客系统中实现的 7 个核心功能亮点。每个功能都解决了实际开发中的具体问题，通过合理的架构设计和工程化实践，确保了系统的可用性、可维护性和扩展性。

整个系统的技术栈是：Next.js 15 + Prisma + ChromaDB + Ollama + Kimi，完全免费的技术方案，既保证了功能完整性，又控制了成本。
...
- 介绍时语速适中，重点强调技术难点和解决方案
- 代码片段只展示关键部分，不要贴太多
- 可以准备一些实际演示，比如展示 RAG 问答效果
- 如果评委追问细节，可以进一步展开说明
